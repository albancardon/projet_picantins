            ...
            <main class="main-connexion ombre">
                ...
                <form class="form-connexion" action="loginBdd" method="post">
                    <div class="form-group">
                        ...
                        <input class="zone-text" type="email" name="mailLogin" id="mailLogin" placeholder="e-mail" value="tintin@milou.fr" required>
                    </div>
                    <div class="form-group">
                        <label class="champ majDbutMot" for="passLogin"> Mon mot de passe</label>
                        <input class="zone-text" type="password" name="passLogin" id="passLogin" placeholder="mot de passe" pattern="[A-Za-z0-9_$]{8,}" value="1234Test" required>
                    </div>
                    ...
                    <form class="form-inscription" action="loginBdd" method="post">
                        ...
                        <div class="inscription-identiter">
                            <p class="champ-inscription">
                                ...
                                pattern="[A-Za-z0-9\u00c0-\u00ff]{3,20}" value="Tintin" required/>
                            </p>
                            <p class="champ-inscription">
                                ...
                                pattern="[A-Za-z0-9\u00c0-\u00ff]{3,20}" value="Milou" required/>
                            </p>
                        </div>
                        <div class="champ-inscription">
                            <label class="label-inscription majDbutMot" for="mailLogin">Mon adresse e-mail</label>
                            <input class="zone-text" type="email" name="mailLogin" id="compte-mail" placeholder="e-mail" value="tintin@milou.fr" required/>
                        ...
                        <div class="champ-inscription">
                            ...
                            <input class="zone-text" type="password" name="passLogin" id="passInscrpt" value="1234Test" placeholder="mot de passe" 
                        ...
                        <div class="champ-inscription">
                            ...
                            <input class="zone-text" type="password" name="passConfirm" id="passConfirm" value="1234Test" placeholder="répétition mot de passe" 
                            pattern="[A-Za-z0-9_$]{8,}" required/>
                        </div>
                        <div class="champ-inscription">
                        ...
                        <div class="champ-inscription">
                            ...
                            pattern="[0-9]{2}[ -]*[0-9]{2}[ -]*[0-9]{2}[ -]*[0-9]{2}[ -]*[0-9]{2}" maxlength="14" value ="03 01 02 03 04" required/>
                            <p class="legende-champ">
